...
import {StyleSheet,View,Image,Text,TouchableHighlight,Animated,Easing,Platform,TouchableOpacity} from 'react-native';
import { screen, system, tool } from '../common'

const [aWidth] = [screen.width-20]
const [left, top] = [0, 0]
const [middleLeft] = [(screen.width - aWidth) / 2];

export default class AlertSelected extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <Animated.View style={[{
            ...
            transform: [{
              translateY: this.state.offset.interpolate({
                inputRange: [0, 1],
                outputRange: [screen.height, (screen.height - this.state.aHeight - 34)]
              }),
            }]
          }]}>
