...
export default class TeacherDetail extends PureComponent {
  //listView: ListView
          ...
          <View>
              <View>
                  ...
                  <View style={styles.classNameContainer}>
                      <Heading1>{info.teacherName}</Heading1>
              ...
              <View style={styles.tipHeader}>
                  <Paragraph style={{fontSize: 14}}>所属机构信息信息</Paragraph>
              </View>
              <Separator />
              <View>
                  <View style={styles.tagContainer}>
                    <TouchableOpacity style={styles.columnContainer} onPress={this.props.onPress}>
                      <View style = {{ flexDirection:'row',alignItems: 'center'}}>
                        ...
                        <Heading2>  </Heading2>
                        <View>
                          <Heading2>{info.insName}</Heading2>
