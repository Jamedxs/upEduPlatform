...
export default class TeacherListScene extends PureComponent {
  static navigationOptions = ({ navigation }) => ({
      headerTitle: (
          <TouchableOpacity style={styles.searchBar}>
              <Image source={require('../../img/Home/search_icon.png')} style={styles.searchIcon} />
              <Paragraph>输入教师姓名</Paragraph>
          </TouchableOpacity>
      ),
  ...
  async requestRecommend() {
      try {
          ...
          let dataList = data.teacherData.map(
              (info) => {
                  return {
                      id: info.teacherId,
  ...
  onCellSelected(info: Object) {
      ...
      this.props.navigation.navigate('TeacherDetail', { info: info })
  }
